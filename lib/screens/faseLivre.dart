...
class _FaseLivreState extends State<FaseLivre> with TickerProviderStateMixin {
  ...
  initGame() {
    ...
    for (int i = 0; i < alfabeto.length; i++) {
      listLetrasAlfabeto.add(
       ItemModel(
            icon: IconData(alfabeto.codeUnitAt(i), fontFamily: 'KTFRoadbrush'),
            name: alfabeto[i],
            value: alfabeto[i]),
      );
    }
    ...
    for (int i = 0; i < 10; i++) {
      listLetras.add(
        ItemModel(
            icon: const IconData(32, fontFamily: 'KTFRoadbrush'),
            name: "",
            value: ""),
      );
    }
                  ...
                  Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                          ...
                          stops: [0.0, 0.45, 1],
                          colors: [Color(0xFF002147), Color(0xFF6ac8fe), Color(0xFF002147)]),
                    ),
