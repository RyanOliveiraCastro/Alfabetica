...
class InitDatabase{
  ...
  criarFases() async {
    await DBProvider.db.newFase(new ItemFase(id: 1, local: "Quarto", name: "CAMA", numeroFase: 1, url: 'assets/images/quarto/2.jpg', lock: false));
    await DBProvider.db.newFase(new ItemFase(id: 2, local: "Quarto", name: "JANELA",numeroFase: 2, url: 'assets/images/quarto/7.jpg', lock: true));
